 ...
 * Multisite_Tab
 *
 * Base class for adding a tab to the network admin "Edit Site" screen.
 * Inlined from the former bernskioldmedia/wp-plugin-base dependency.
 */
abstract class Multisite_Tab implements Hookable {
	...
	public static function add_page(): void {
		add_submenu_page( '', static::get_title(), static::get_title(), static::$capability, static::$slug, [ static::class, 'render' ] );
	}

	/**
	 * Add the tab to the "Edit Site" nav.
	 *
	 * @param  array  $tabs
	 *
	 * @return array
	...
	/**
	 * Get the WP_Site object from the request.
	 */
